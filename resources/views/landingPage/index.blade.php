<x-guest-layout>
    ...
    <section class="page-section bg-light" id="portfolio">
        <div class="container">
            ...
            <div class="row">@foreach ($kos as $place)
    ...
    <section class="page-section" id="contact">
        <div class="container">
            <div class="text-center">
                ...
                <h3 class="section-subheading text-muted">Berikan kami masukan untuk menjadi lebih baik.</h3>
            </div>
            <form id="contactForm" method="POST" action="{{ route('tambahPesan') }}" enctype="multipart/form-data">
                @csrf
                @method("POST")
                <div class="row align-items-stretch mb-5">
                    <div class="col-md-6">
                        <div class="form-group">
                            <!-- Name input-->
                            <input class="form-control" id="name" name="name" type="text" placeholder="Nama kamu *" />
                        </div>
                        <div class="form-group">
                            <!-- Email address input-->
                            <input class="form-control" id="email" name="email" type="email" placeholder="Email kamu *"/>
                        </div>
                        <div class="form-group mb-md-0">
                            <!-- Phone number input-->
                            <input class="form-control" id="phone" name="phone" type="tel" placeholder="Nomor wa/hp kamu *" />
                        </div>
                    </div>
                    <div class="col-md-6">
                        <div class="form-group form-group-textarea mb-md-0">
                            <!-- Message input-->
                            <textarea class="form-control" id="message" name="message" placeholder="Tulis saran dan kritik di sini *" ></textarea>
                        </div>
                    </div>
                </div>
                <!-- Submit Button-->
